    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                {!! Form::model($data['service'], ['route' => ['service.update', $data['service']->id],'method' => 'put']) !!}
                @include('backend.service.mainform')
                <div class="form-group">
                    {{ Form::button('<i class="fa fa-save"></i> Update Service', ['type' => 'submit', 'class' => 'btn btn-warning btn-sm'] )  }}
