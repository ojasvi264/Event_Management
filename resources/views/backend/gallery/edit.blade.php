...
@section('title','Gallery Edit page')
@section('content')
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                {!! Form::model($data['gallery'], ['route' => ['gallery.update', $data['gallery']->id],'method' => 'put']) !!}
                @include('backend.gallery.mainform')
                <div class="form-group">
                    {{ Form::button('<i class="fa fa-save"></i> Update Gallery', ['type' => 'submit', 'class' => 'btn btn-warning btn-sm'] )  }}
