    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                {!! Form::model($data['team'], ['route' => ['team.update', $data['team']->id],'method' => 'put']) !!}
                @include('backend.team.mainform')
                <div class="form-group">
                    {{ Form::button('<i class="fa fa-save"></i> Update Team', ['type' => 'submit', 'class' => 'btn btn-warning btn-sm'] )  }}
